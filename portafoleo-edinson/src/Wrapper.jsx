...
export default function App() {
  ...
  return (
    <div className='conten' style={{backgroundColor:"#3d5a80", padding:"0px", margin:"0px",}}>
      ...
      <p className='tex' style={{textAlign:'center', fontWeight:'bolder' }}>contactame a mi correo electronico en el boton de abajo, asepto toda clase de recomendaciones </p>
      <div style={{
